# Raddex v0.3.6 Release Checklist
...
- [x] Create and push the `v0.3.6` tag from the merge commit.
...
- Release: [v0.3.6](https://github.com/chulingera2025/raddex/releases/tag/v0.3.6).
